    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="max-w-6xl mx-auto px-6 py-16">
            ...
            <div className="flex items-center gap-2">
              {socialLinks.filter(link => link.show).map((link, index) => (
                <a
                  ...
                  className="size-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-accent transition-all duration-300"
        ...
        <div className="pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          {developerInfo.cvUrl && developerInfo.cvUrl !== '#' && (
            <a
